 ...
 */
@Entity
@SqlResultSetMapping(name = "Ranking", classes = {
    @ConstructorResult(targetClass = Ranking.class,
            columns = {
...
@NamedQueries({
    ...
    , @NamedQuery(name = "Sheetmusic.findByOwner", query = "SELECT s FROM Sheetmusic s WHERE s.owner.username = :owner")})
